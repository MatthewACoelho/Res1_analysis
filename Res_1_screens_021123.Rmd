...
geom_hline(yintercept=c(0,0),linetype="dotted") +
geom_vline(xintercept=c(0,0),linetype="dotted") +
geom_text_repel(aes(label=ifelse(L2FC_H23_Adag_plasmid_average_zscore > 4.2 & (is.na(Amino_Acid_Position) == FALSE) & Gene %in% c("KRAS", "MAP2K1", "MAP2K2") | L2FC_H23_Sotor_plasmid_average_zscore > 4.2 & (is.na(Amino_Acid_Position) == FALSE) & Gene %in% c("KRAS", "MAP2K1", "MAP2K2"), paste(Amino_Acid_Position),"")), size = 3, position = pos, max.overlaps = Inf) +
scale_color_manual( values =c("royalblue", "turquoise3", "orange", "red", "springgreen4", "grey55", "brown", "purple", "salmon", "pink", "black")) +
scale_shape_manual(values =c(19, 1)) +
theme_classic()
plot5
...
annotate("text", y = 12.2, x = 3.4, label = paste("p =", formatC(t_test_1$p.value, digits = 2)), parse = FALSE, size = 4) +
theme_classic()
plot1
...
geom_point(size=3, alpha=1, position = pos, shape = 1) +
geom_violin(colour = "salmon", alpha = 1) +
annotate("text", y = 12.2, x = 2.7, label = paste("p =", formatC(t_test_2$p.value, digits = 2)), parse = FALSE, size = 4) +
theme_classic()
plot3
...
geom_point(size=3, alpha=1, position = pos, shape = 1) +
geom_violin(colour = "salmon", alpha = 1) +
annotate("text", y = 12.2, x = 2.5, label = paste("p =", formatC(t_test_3$p.value, digits = 2)), parse = FALSE, size = 4) +
theme_classic()
plot2
...
geom_point(size=3, alpha=1, position = pos, shape = 1) +
geom_violin(colour = "salmon", alpha = 1) +
annotate("text", y = 12.2, x = 2.5, label = paste("p =", formatC(t_test_4$p.value, digits = 2)), parse = FALSE, size = 4) +
theme_classic()
plot3
...
filtered_annotated_data %>% count(variant_class_Debcet, Gene)
filtered_annotated_data %>% count(variant_class_Tram, Gene)
filtered_annotated_data %>% count(variant_class_Pict, Gene)
filtered_annotated_data %>% count(variant_class_Sotor, Gene)
filtered_annotated_data %>% count(variant_class_Adag, Gene)
filtered_annotated_data %>% count(variant_class_Gefit, Gene)
filtered_annotated_data %>% count(variant_class_Osim, Gene)

filtered_test_clean_MHHES1_data %>% count(variant_class_Olap, Gene)
filtered_test_clean_MHHES1_data %>% count(variant_class_Nirap, Gene)
```
...
#join with Discussion_table
Discussion_table <- left_join(Discussion_table, citations)
...
plot5 <- ggplot(Discussion_table, aes(x= diffusion_score, y= L2FC_HT29_DebCet_plasmid_average_zscore, colour = vaf)) + 
geom_point(size=3,  position = pos) +
labs(title= "HT29", x = "perturb-seq diffusion_score", y = "vL2FC_HT29_DebCet_plasmid_average_zscore", colour = "VAF") +
theme_bw(base_size = 15)
plot5

plot6 <- ggplot(Discussion_table, aes(x= PFS_outcome_score, y= L2FC_HT29_DebCet_plasmid_average_zscore, colour = vaf)) + 
geom_point(size=3,  position = pos) +
...
PE_amp_seq <- as_tibble(read.csv("PE_EGFR_3226_variant_data.csv", stringsAsFactors = FALSE, header = TRUE))

PE_amp_seq_filtered <- PE_amp_seq %>% filter(str_detect(protein, "A1013|C797|D1006|D1012|T790|V1011"))
...
plot1 <- ggplot(PE_amp_seq_filtered, aes(y= condition, x= vaf)) +
geom_point(size=3,  position = pos) +
labs(title= "PC9 - prime editing screens", y = "", x = "vaf") +
#geom_text_repel(aes(label=vaf), size = 3, position = pos, max.overlaps = Inf) +
  theme_bw(base_size = 15) +
...
plot1 <- ggplot(subset(PE_amp_seq_filtered, protein %in% c("p.C797S", "p.T790M","p.A1013D")), aes(y= condition, x= vaf)) +
geom_point(size=3) +
labs(title= "PC9 - prime editing screens", y = "", x = "vaf") +
geom_text_repel(aes(label=vaf), size = 3, position = pos, max.overlaps = Inf) +
  theme_bw(base_size = 15) +
...
```{r}
# convert vaf into comparable conditions between smaple using pivot_wider
pegRNA_counts
PE_amp_seq_filtered
PE_amp_seq_filtered %>% 
  select(!c(X))%>%
...
plot3 <- ggplot(PE_amp_seq_VAF, aes(y= control_exp1, x= osimertinib_exp1)) +
geom_point(size=3) +
labs(title= "PC9 - prime editing screens", y = "control_exp1", x = "osimertinib_exp1") +
geom_text_repel(aes(label=protein), size = 3, max.overlaps = Inf) +
  theme_bw(base_size = 15) 
plot3

plot4 <- ggplot(PE_amp_seq_VAF, aes(y= control_exp2, x= osimertinib_exp2)) +
geom_point(size=3) +
labs(title= "PC9 - prime editing screens", y = "control_exp2", x = "osimertinib_exp2") +
geom_text_repel(aes(label=protein), size = 3, max.overlaps = Inf) +
  theme_bw(base_size = 15) 
plot4
```
...
plot1 <- ggplot(PE_amp_seq_VAF, aes(y= t7_exp1, x= gefitinib_exp1)) +
geom_point(size=3) +
...
plot2 <- ggplot(PE_amp_seq_VAF, aes(y= t7_exp2, x= gefitinib_exp2)) +
geom_point(size=3) +
...
plot3 <- ggplot(PE_amp_seq_VAF, aes(y= t7_exp1, x= osimertinib_exp1)) +
geom_point(size=3) +
labs(title= "PC9 - prime editing screens", y = "t7_exp1", x = "osimertinib_exp1") +
geom_text_repel(aes(label=protein), size = 3, max.overlaps = Inf) +
  theme_bw(base_size = 15) 
plot3

plot4 <- ggplot(PE_amp_seq_VAF, aes(y= t7_exp2, x= osimertinib_exp2)) +
geom_point(size=3) +
labs(title= "PC9 - prime editing screens", y = "t7_exp2", x = "osimertinib_exp2") +
geom_text_repel(aes(label=protein), size = 3, max.overlaps = Inf) +
  theme_bw(base_size = 15) 
plot4
```
...
plot1 <- ggplot(PE_amp_seq_VAF, aes(y= t0_exp1, x= gefitinib_exp1)) +
geom_point(size=3) +
...
plot2 <- ggplot(PE_amp_seq_VAF, aes(y= t0_exp2, x= gefitinib_exp2)) +
geom_point(size=3) +
...
plot3 <- ggplot(PE_amp_seq_VAF, aes(y= t0_exp1, x= osimertinib_exp1)) +
geom_point(size=3) +
labs(title= "PC9 - prime editing screens", y = "t0_exp1", x = "osimertinib_exp1") +
geom_text_repel(aes(label=protein), size = 3, max.overlaps = Inf) +
  theme_bw(base_size = 15) 
plot3

plot4 <- ggplot(PE_amp_seq_VAF, aes(y= t0_exp2, x= osimertinib_exp2)) +
geom_point(size=3) +
labs(title= "PC9 - prime editing screens", y = "t0_exp2", x = "osimertinib_exp2") +
geom_text_repel(aes(label=protein), size = 3, max.overlaps = Inf) +
  theme_bw(base_size = 15) 
plot4
```
...
PE_amp_seq_VAF <- PE_amp_seq_VAF %>% 
  mutate(vaf_osimertinib_vs_control_exp1 = osimertinib_exp2/control_exp1)
PE_amp_seq_VAF <- PE_amp_seq_VAF %>% 
  mutate(vaf_osimertinib_vs_control_exp2 = osimertinib_exp2/control_exp2)

PE_amp_seq_VAF_join <- left_join(pegRNA_counts, PE_amp_seq_VAF)
PE_amp_seq_VAF
```
...
geom_point(size=3) +
labs(title= "PC9 - prime editing screens", y = "L2FC_PC9_gefit_control_2_zscore", x = "vaf_gefitinib_vs_control_exp2") +
geom_text_repel(aes(label=protein), size = 3, max.overlaps = Inf) +
  theme_bw(base_size = 15) 
plot2

plot3 <- ggplot(PE_amp_seq_VAF_join, aes(y= L2FC_PC9_osi_control_1_zscore, x= vaf_osimertinib_vs_control_exp1)) +
geom_point(size=3) +
labs(title= "PC9 - prime editing screens", y = "L2FC_PC9_osi_control_1_zscore", x = "vaf_osimertinib_vs_control_exp1") +
geom_text_repel(aes(label=protein), size = 3, max.overlaps = Inf) +
  theme_bw(base_size = 15) 
plot3

plot4 <- ggplot(PE_amp_seq_VAF_join, aes(y= L2FC_PC9_osi_control_2_zscore, x= vaf_osimertinib_vs_control_exp2)) +
geom_point(size=3) +
labs(title= "PC9 - prime editing screens", y = "L2FC_PC9_osi_control_2_zscore", x = "vaf_osimertinib_vs_control_exp2") +
geom_text_repel(aes(label=protein), size = 3, max.overlaps = Inf) +
  theme_bw(base_size = 15) 
plot4
```
...
#check T790M for osi
filtered_annotated_data %>% 
  filter(str_detect(Amino_Acid_Position, "790")) %>%
  filter(Gene == "EGFR") %>%
    select(L2FC_PC9_Control_plasmid_average_zscore, L2FC_PC9_Osim_plasmid_average_zscore, L2FC_PC9_Osim_plasmid_1_zscore, L2FC_PC9_Osim_plasmid_2_zscore, L2FC_PC9_Osim_plasmid_scres1valid_zscore, L2FC_PC9_Gefit_plasmid_scres1valid_zscore, L2FC_PC9_Gefit_plasmid_average_zscore, Protein_Change, Amino_Acid_Position)
```
```{r}
...
```{r}
# merge filtered MHHES1 data with the rest and write a new supplementray table with all data and z-scores
filtered_annotated_data
filtered_test_clean_MHHES1_data

Supplementary_Table_X <- left_join(filtered_annotated_data,filtered_test_clean_MHHES1_data)
write.csv(Supplementary_Table_X, "Supplementary_Table_X.csv")
```

```{r}
# extract interesting non-protein-coding hits
