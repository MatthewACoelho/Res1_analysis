...
geom_smooth(method = lm) +
annotate("text", y = 5, x = 0, label = paste("R = ", round(r12, 2)), parse = FALSE, size = 7) +
theme_bw(base_size = 15)
plot4
...
geom_smooth(method = lm) +
annotate("text", y = 5, x = 0, label = paste("R = ", round(r13, 2)), parse = FALSE, size = 7) +
theme_bw(base_size = 15)
plot5
...
geom_smooth(method = lm) +
annotate("text", y = 5, x = 0, label = paste("R = ", round(r14, 2)), parse = FALSE, size = 7) +
theme_bw(base_size = 15)
plot6
...
r17 <- cor(data$L2FC_PC9_CBE_Osim_plasmid_1_zscore, data$L2FC_PC9_CBE_Osim_plasmid_2_zscore, method = "pearson")
r18 <- cor(data$L2FC_PC9_ABE_Control_plasmid_1_zscore, data$L2FC_PC9_ABE_Control_plasmid_2_zscore, method = "pearson")
r19 <- cor(data$L2FC_PC9_ABE_Gefit_plasmid_1_zscore, data$L2FC_PC9_ABE_Gefit_plasmid_2_zscore, method = "pearson")
r20 <- cor(data$L2FC_PC9_ABE_Osim_plasmid_1_zscore, data$L2FC_PC9_ABE_Osim_plasmid_2_zscore, method = "pearson")
```
...
geom_smooth(method = lm) +
annotate("text", y = 5, x = 0, label = paste("R = ", round(r16, 2)), parse = FALSE, size = 7) +
theme_bw(base_size = 15)
plot2
ggsave("FigS2_16.eps", width = 6, height = 4.3, path ="/Users/mc32/Documents/Matt_Coelho/Bioinformatics/Res1/figures_export")

# CBE Osim vs plasmid
plot3 <- ggplot(subset(data, sgRNA_type %in% c("exonic")), aes(x= L2FC_PC9_CBE_Osim_plasmid_1_zscore, y= L2FC_PC9_CBE_Osim_plasmid_2_zscore)) + geom_pointdensity(size=3,  position = pos) +
...
geom_smooth(method = lm) +
annotate("text", y = 5, x = 0, label = paste("R = ", round(r17, 2)), parse = FALSE, size = 7) +
theme_bw(base_size = 15)
plot3
ggsave("FigS2_17.eps", width = 6, height = 4.3, path ="/Users/mc32/Documents/Matt_Coelho/Bioinformatics/Res1/figures_export")

# ABE control vs plasmid
plot4 <- ggplot(subset(data, sgRNA_type %in% c("exonic")), aes(x= L2FC_PC9_ABE_Control_plasmid_1_zscore, y= L2FC_PC9_ABE_Control_plasmid_2_zscore)) +
geom_pointdensity(size=3,  position = pos) +
scale_color_viridis_c() +
...
geom_smooth(method = lm) +
annotate("text", y = 5, x = 0, label = paste("R = ", round(r18, 2)), parse = FALSE, size = 7) +
theme_bw(base_size = 15)
plot4
ggsave("FigS2_18.eps", width = 6, height = 4.3, path ="/Users/mc32/Documents/Matt_Coelho/Bioinformatics/Res1/figures_export")

# ABE Gefit vs plasmid
plot5 <- ggplot(subset(data, sgRNA_type %in% c("exonic")), aes(x= L2FC_PC9_ABE_Gefit_plasmid_1_zscore, y= L2FC_PC9_ABE_Gefit_plasmid_2_zscore)) +
geom_pointdensity(size=3,  position = pos) +
scale_color_viridis_c() +
...
# ABE Osim vs plasmid
plot6 <- ggplot(subset(data, sgRNA_type %in% c("exonic")), aes(x= L2FC_PC9_ABE_Osim_plasmid_1_zscore, y= L2FC_PC9_ABE_Osim_plasmid_2_zscore)) +
geom_pointdensity(size=3,  position = pos) +
scale_color_viridis_c() +
...
theme_classic()
plot1
ggsave("Fig3c_1.eps", width = 6, height = 4.3, path ="/Users/mc32/Documents/Matt_Coelho/Bioinformatics/Res1/figures_export")
...
theme_classic()
plot2
ggsave("Fig3c_2.eps", width = 6, height = 4.3, path ="/Users/mc32/Documents/Matt_Coelho/Bioinformatics/Res1/figures_export")
...
theme_classic()
plot3
ggsave("Fig3c_3.eps", width = 6, height = 4.3, path ="/Users/mc32/Documents/Matt_Coelho/Bioinformatics/Res1/figures_export")
```

```{r}
# replicate correlation - stats MHH-ES-1
r21 <- cor(data$L2FC_MHHES1_ABE_Control_plasmid_1_zscore, data$L2FC_MHHES1_ABE_Control_plasmid_2_zscore, method = "pearson")
r22 <- cor(data$L2FC_MHHES1_ABE_Olap_plasmid_1_zscore, data$L2FC_MHHES1_ABE_Olap_plasmid_2_zscore, method = "pearson")
r23 <- cor(data$L2FC_MHHES1_ABE_Nirap_plasmid_1_zscore, data$L2FC_MHHES1_ABE_Nirap_plasmid_2_zscore, method = "pearson")
```
...
geom_text_repel(aes(label=ifelse(L2FC_HT29_Tram_plasmid_average_zscore > 2.5 & (is.na(Amino_Acid_Position) == FALSE), paste(Amino_Acid_Position, Gene), ifelse( L2FC_HT29_Tram_plasmid_1_zscore > 2.5 & (is.na(Amino_Acid_Position) == TRUE),  paste(most_severe_consequence, Gene), ifelse(L2FC_HT29_Tram_plasmid_average_zscore < -1.6 & L2FC_HT29_Control_plasmid_average_zscore > - 0.25, paste(most_severe_consequence, Gene), "")))), size = 3, position = pos) +
...
geom_hline(yintercept=c(0,0),linetype="dotted") +
geom_vline(xintercept=c(0,0),linetype="dotted") +
geom_text_repel(aes(label=ifelse(L2FC_HT29_Pict_plasmid_average_zscore > 1.2 | L2FC_HT29_Control_plasmid_average_zscore > 1.5, paste(Amino_Acid_Position, ",", Gene), "")), size = 3, position = pos) +
scale_color_manual(values =c("royalblue", "turquoise3", "orange", "red", "springgreen4", "grey55", "brown", "purple", "pink", "salmon", "black")) +
scale_shape_manual(values =c(19, 1)) +
theme_classic()
plot2
...
geom_hline(yintercept=c(0,0),linetype="dotted") +
geom_vline(xintercept=c(0,0),linetype="dotted") +
geom_text_repel(aes(label=ifelse(L2FC_HT29_DebCet_plasmid_average_zscore > 2.5 & (is.na(Amino_Acid_Position) == FALSE)| L2FC_HT29_Control_plasmid_average_zscore > 1.5 & (is.na(Amino_Acid_Position) == FALSE), paste(Amino_Acid_Position, Gene), ifelse(L2FC_HT29_DebCet_plasmid_average_zscore > 2.5 & (is.na(Amino_Acid_Position) == TRUE) | L2FC_HT29_Control_plasmid_average_zscore > 1.5 & (is.na(Amino_Acid_Position) == TRUE), paste(most_severe_consequence, Gene), ""))), size = 3, position = pos) +
scale_color_manual(values =c("royalblue", "turquoise3", "orange", "red", "springgreen4", "grey55", "brown", "purple", "pink", "salmon", "black")) +
scale_shape_manual(values =c(19, 1)) +
theme_classic()
plot3
...
geom_hline(yintercept=c(0,0),linetype="dotted") +
geom_vline(xintercept=c(0,0),linetype="dotted") +
geom_text_repel(aes(label=ifelse(L2FC_H23_Adag_plasmid_average_zscore > 1.8 & (is.na(Amino_Acid_Position) == FALSE)| L2FC_H23_Sotor_plasmid_average_zscore > 1.5 & (is.na(Amino_Acid_Position) == FALSE), paste(Amino_Acid_Position, Gene), ifelse(L2FC_H23_Adag_plasmid_average_zscore > 1.8 & (is.na(Amino_Acid_Position) == TRUE)| L2FC_H23_Sotor_plasmid_average_zscore > 1.5 & (is.na(Amino_Acid_Position) == TRUE), paste(most_severe_consequence, Gene),""))), size = 3, position = pos) +
scale_color_manual( values =c("royalblue", "turquoise3", "orange", "red", "springgreen4", "grey55", "brown", "purple", "pink", "salmon", "black")) +
scale_shape_manual(values =c(19, 1)) +
theme_classic()
plot5
...
geom_hline(yintercept=c(0,0),linetype="dotted") +
geom_vline(xintercept=c(0,0),linetype="dotted") +
geom_text_repel(aes(label=ifelse(L2FC_PC9_Gefit_plasmid_average_zscore > 7 & (is.na(Amino_Acid_Position) == FALSE) | L2FC_PC9_Gefit_plasmid_average_zscore < -2.5 & L2FC_PC9_Control_plasmid_average_zscore > -0.4 & (is.na(Amino_Acid_Position) == FALSE), paste(Amino_Acid_Position, Gene), ifelse(L2FC_PC9_Gefit_plasmid_average_zscore > 7 & (is.na(Amino_Acid_Position) == TRUE) | L2FC_PC9_Gefit_plasmid_average_zscore < -2.5 & L2FC_PC9_Control_plasmid_average_zscore > -0.4 & (is.na(Amino_Acid_Position) == TRUE), paste(most_severe_consequence, Gene), ifelse(L2FC_PC9_Gefit_plasmid_average_zscore > 7 & L2FC_PC9_Control_plasmid_average_zscore < -1.9, paste(Amino_Acid_Position, Gene), ifelse(L2FC_PC9_Gefit_plasmid_average_zscore > 7 & L2FC_PC9_Control_plasmid_average_zscore > 1, paste(Amino_Acid_Position, Gene), ""))))), size = 3, position = pos) +
scale_color_manual( values =c("royalblue", "turquoise3", "orange", "red", "springgreen4", "grey55", "brown", "purple", "pink", "salmon", "black")) +
scale_shape_manual(values =c(19, 1)) +
theme_classic()
plot1
...
geom_hline(yintercept=c(0,0),linetype="dotted") +
geom_vline(xintercept=c(0,0),linetype="dotted") +
geom_text_repel(aes(label=ifelse(L2FC_PC9_Osim_plasmid_average_zscore > 2 & (is.na(Amino_Acid_Position) == FALSE) | L2FC_PC9_Osim_plasmid_average_zscore < -2 & L2FC_PC9_Control_plasmid_average_zscore > -0.4 & (is.na(Amino_Acid_Position) == FALSE), paste(Amino_Acid_Position, Gene), ifelse(L2FC_PC9_Osim_plasmid_average_zscore > 2 & (is.na(Amino_Acid_Position) == TRUE) | L2FC_PC9_Osim_plasmid_average_zscore < -2 & L2FC_PC9_Control_plasmid_average_zscore > -0.4 & (is.na(Amino_Acid_Position) == TRUE), paste(most_severe_consequence, Gene), ifelse(L2FC_PC9_Osim_plasmid_average_zscore >0.5 & L2FC_PC9_Control_plasmid_average_zscore < -1.8, paste(Amino_Acid_Position, Gene), ifelse(L2FC_PC9_Osim_plasmid_average_zscore >2 & L2FC_PC9_Control_plasmid_average_zscore >1, paste(Amino_Acid_Position, Gene), ""))))), size = 3, position = pos) +
scale_color_manual( values =c("royalblue", "turquoise3", "orange", "red", "springgreen4", "grey55", "brown", "purple", "pink", "salmon", "black")) +
scale_shape_manual(values =c(19, 1)) +
theme_classic()
plot2
...
annotated_data %>% filter(L2FC_MHHES1_Control_plasmid_average_zscore >3) %>%
  select(Gene, G_guide, most_severe_consequence, Amino_Acid_Position, editor, Edit_Location)

annotated_data %>% filter(L2FC_MHHES1_Olap_plasmid_average_zscore >3) %>%
  select(Gene, G_guide, most_severe_consequence, Amino_Acid_Position, editor, Protein_Change)

annotated_data %>% filter(L2FC_MHHES1_Nirap_plasmid_average_zscore >4) %>%
  select(Gene, G_guide, most_severe_consequence, Amino_Acid_Position, editor, Protein_Change)

annotated_data %>% filter(L2FC_MHHES1_Olap_plasmid_average_zscore < -3.5 & L2FC_MHHES1_Control_plasmid_average_zscore > -1) %>%
  select(Gene, G_guide, most_severe_consequence, Amino_Acid_Position, editor, Protein_Change)

annotated_data %>% filter(L2FC_MHHES1_Nirap_plasmid_average_zscore < -3.5 & L2FC_MHHES1_Control_plasmid_average_zscore > -1) %>%
  select(Gene, G_guide, most_severe_consequence, Amino_Acid_Position, editor, Protein_Change)

annotated_data %>% filter(L2FC_MHHES1_Olap_plasmid_average_zscore < -3.5 & L2FC_MHHES1_Nirap_plasmid_average_zscore < -3.5 & L2FC_MHHES1_Control_plasmid_average_zscore > -0.8) %>%
...
PARP_sensitors <- annotated_data %>% filter(L2FC_MHHES1_Olap_plasmid_average_zscore < -3.5 & L2FC_MHHES1_Nirap_plasmid_average_zscore < -3.5 & L2FC_MHHES1_Control_plasmid_average_zscore > -0.8) %>%
  select(sgRNA_ID)
```
...
plot1 <- ggplot(subset(annotated_data, Gene %in% c(targets)), aes(x=L2FC_MHHES1_Control_plasmid_average_zscore, y= L2FC_MHHES1_Olap_plasmid_average_zscore, colour = Gene, shape = editor)) + 
geom_point(position = pos, alpha = 1, size =3) +
labs(title= "", x="MHH-ES-1 control vs plasmid (z-score)", y = "MHH-ES-1 olaparib vs plasmid (z-score)", colour = "gene") +
geom_hline(yintercept=c(0,0),linetype="dotted") +
geom_vline(xintercept=c(0,0),linetype="dotted") +
geom_text_repel(aes(label=ifelse(L2FC_MHHES1_Olap_plasmid_average_zscore > 3.1 & (is.na(Amino_Acid_Position) == FALSE), paste(Amino_Acid_Position, Gene), ifelse(L2FC_MHHES1_Olap_plasmid_1_zscore > 3.1 & (is.na(Amino_Acid_Position) == TRUE),  paste(most_severe_consequence, Gene), ifelse(L2FC_MHHES1_Control_plasmid_average_zscore > 3.5, paste(most_severe_consequence, Gene), ifelse(sgRNA_ID %in% PARP_sensitors$sgRNA_ID, paste(Gene, Amino_Acid_Position), ""))))), size = 3, position = pos, max.overlaps = Inf) +
scale_color_manual( values =c("royalblue", "turquoise3", "orange", "red", "springgreen4", "grey55", "brown", "purple", "pink", "salmon", "black")) +
scale_shape_manual(values =c(19, 1)) +
theme_classic() 
plot1

plot2 <- ggplot(subset(annotated_data, Gene %in% c(targets)), aes(x=L2FC_MHHES1_Control_plasmid_average_zscore, y= L2FC_MHHES1_Nirap_plasmid_average_zscore, colour = Gene, shape = editor)) + 
geom_point(position = pos, alpha = 1, size =3) +
labs(title= "", x="MHH-ES-1 control vs plasmid (z-score)", y = "MHH-ES-1 niraparib vs plasmid (z-score)", colour = "gene") +
geom_hline(yintercept=c(0,0),linetype="dotted") +
geom_vline(xintercept=c(0,0),linetype="dotted") +
geom_text_repel(aes(label=ifelse(L2FC_MHHES1_Nirap_plasmid_average_zscore > 5 & (is.na(Amino_Acid_Position) == FALSE), paste(Amino_Acid_Position, Gene), ifelse( L2FC_MHHES1_Nirap_plasmid_1_zscore > 5 & (is.na(Amino_Acid_Position) == TRUE),  paste(most_severe_consequence, Gene), ifelse(L2FC_MHHES1_Control_plasmid_average_zscore > 3.5, paste(most_severe_consequence, Gene), ifelse(sgRNA_ID %in% PARP_sensitors$sgRNA_ID, paste(Gene, Amino_Acid_Position), ""))))), size = 3, position = pos, max.overlaps = Inf) +
scale_color_manual( values =c("royalblue", "turquoise3", "orange", "red", "springgreen4", "grey55", "brown", "purple", "pink", "salmon", "black")) +
scale_shape_manual(values =c(19, 1)) +
theme_classic()
plot2
...
geom_hline(yintercept=c(0,0),linetype="dotted") +
geom_text_repel(aes(label=ifelse(L2FC_HT29_Control_plasmid_average_zscore > 1 & (is.na(Amino_Acid_Position) == FALSE), paste(Amino_Acid_Position),  "")), position = pos, size = 4) +
...
geom_hline(yintercept=c(0,0),linetype="dotted") +
geom_text_repel(aes(label=ifelse(L2FC_HT29_Control_plasmid_average_zscore > 1.2 & (is.na(Amino_Acid_Position) == FALSE), paste(Amino_Acid_Position),  "")), position = pos, size = 4) +
scale_size(range = c(3, 10)) +
theme_classic()
plot2
...
geom_hline(yintercept=c(0,0),linetype="dotted") +
geom_text_repel(aes(label=ifelse(L2FC_HT29_Control_plasmid_average_zscore > 0.7 | L2FC_HT29_Control_plasmid_average_zscore < -2.5, paste(PTM), "")), size = 3, position = pos) +
...
plot1 <- ggplot(subset(annotated_data, Gene %in% c(targets) & (is.na(Amino_Acid_Position_simple) ==FALSE)), aes(x=Amino_Acid_Position_simple, y= L2FC_MHHES1_Control_plasmid_average_zscore, shape = most_severe_consequence, colour = curated_Domain)) + 
geom_point(position = pos, alpha = 1, size = 3) +
labs(title= "", x="PARP1/2 amino acid position", y = "MHH-ES-1 control vs plasmid (z-score)", colour = "domain", shape = "consequence") +
geom_hline(yintercept=c(0,0),linetype="dotted") +
geom_text_repel(aes(label=ifelse(L2FC_MHHES1_Control_plasmid_average_zscore > 1 | L2FC_MHHES1_Control_plasmid_average_zscore < -3, paste(PTM), "")), size = 3, position = pos, max.overlaps = Inf) +
...
plot2 <- ggplot(subset(annotated_data, Gene %in% c(targets) & (is.na(Amino_Acid_Position_simple) ==FALSE)), aes(x=Amino_Acid_Position_simple, y= L2FC_MHHES1_Olap_plasmid_average_zscore, shape = most_severe_consequence, colour = curated_Domain)) + 
geom_point(position = pos, alpha = 1, size = 3) +
labs(title= "", x="PARP1/2 amino acid position", y = "MHH-ES-1 olaparib vs plasmid (z-score)", colour = "domain", shape = "consequence") +
geom_hline(yintercept=c(0,0),linetype="dotted") +
geom_text_repel(aes(label=ifelse(L2FC_MHHES1_Olap_plasmid_average_zscore > 1 | L2FC_MHHES1_Olap_plasmid_average_zscore < -3, paste(PTM), "")), size = 3, position = pos, max.overlaps = Inf) +
scale_color_manual(values =c("grey55", "purple", "black", "royalblue", "orange", "red", "salmon", "red3", "blue3", "pink3", "yellow4", "grey35", "grey75", "orange3", "green3")) +
scale_shape_manual(values=c(1, 19, 2, 11, 7, 3)) +
theme_classic() +
facet_wrap(~Gene, scales = "free_x", nrow = 2)
...
plot3 <- ggplot(subset(annotated_data, Gene %in% c(targets) & (is.na(Amino_Acid_Position_simple) ==FALSE)), aes(x=Amino_Acid_Position_simple, y= L2FC_MHHES1_Nirap_plasmid_average_zscore, shape = most_severe_consequence, colour = curated_Domain)) + 
geom_point(position = pos, alpha = 1, size = 3) +
labs(title= "", x="PARP1/2 amino acid position", y = "MHH-ES-1 niraparib vs plasmid (z-score)", colour = "domain", shape = "consequence") +
geom_hline(yintercept=c(0,0),linetype="dotted") +
geom_text_repel(aes(label=ifelse(L2FC_MHHES1_Nirap_plasmid_average_zscore > 1 | L2FC_MHHES1_Nirap_plasmid_average_zscore < -3, paste(PTM), "")), size = 3, position = pos, max.overlaps = Inf) +
scale_color_manual(values =c("grey55", "purple", "black", "royalblue", "orange", "red", "salmon", "red3", "blue3", "pink3", "yellow4", "grey35", "grey75", "orange3", "green3")) +
scale_shape_manual(values=c(1, 19, 2, 11, 7, 3)) +
theme_classic() +
facet_wrap(~Gene, scales = "free_x", nrow = 2)
...
plot1 <- ggplot(subset(annotated_data, Gene %in% c(targets) & (is.na(Amino_Acid_Position_simple) ==FALSE)), aes(x=Amino_Acid_Position_simple, y= L2FC_MHHES1_Control_plasmid_average_zscore, colour = Gene)) + 
geom_point(position = pos, alpha = 1, size = 3) +
labs(title= "", x="PARP1/2 amino acid position", y = "MHH-ES-1 control vs plasmid (z-score)", colour = "gene") +
geom_hline(yintercept=c(0,0),linetype="dotted") +
geom_text_repel(aes(label=ifelse(L2FC_MHHES1_Control_plasmid_average_zscore > 3, paste(Amino_Acid_Position), "")), size = 3, position = pos, max.overlaps = Inf) +
scale_color_manual(values =c("pink2", "salmon")) +
scale_shape_manual(values=c(19, 2, 11, 7, 3)) +
theme_classic() +
facet_wrap(~Gene, scales = "free_x", nrow = 2) +
scale_y_continuous(limits = c(-6, 5))
plot1
ggsave("Fig3d_1.eps", width = 6, height = 4, path ="/Users/mc32/Documents/Matt_Coelho/Bioinformatics/Res1/figures_export")

plot2 <- ggplot(subset(annotated_data, Gene %in% c(targets) & (is.na(Amino_Acid_Position_simple) ==FALSE)), aes(x=Amino_Acid_Position_simple, y= L2FC_MHHES1_Olap_plasmid_average_zscore, colour = Gene)) + 
geom_point(position = pos, alpha = 1, size = 3) +
...
scale_y_continuous(limits = c(-6, 5))
plot2
ggsave("Fig3d_2.eps", width = 6, height = 4, path ="/Users/mc32/Documents/Matt_Coelho/Bioinformatics/Res1/figures_export")

plot3 <- ggplot(subset(annotated_data, Gene %in% c(targets) & (is.na(Amino_Acid_Position_simple) ==FALSE)), aes(x=Amino_Acid_Position_simple, y= L2FC_MHHES1_Nirap_plasmid_average_zscore, colour = Gene)) + 
geom_point(position = pos, alpha = 1, size = 3) +
labs(title= "", x="PARP1/2 amino acid position", y = "MHH-ES-1 niraparib vs plasmid (z-score)", colour = "gene") +
geom_hline(yintercept=c(0,0),linetype="dotted") +
geom_text_repel(aes(label=ifelse(L2FC_MHHES1_Nirap_plasmid_average_zscore > 3.8, paste(Amino_Acid_Position),ifelse(sgRNA_ID %in% PARP_sensitors$sgRNA_ID, paste(Amino_Acid_Position), ""))), size = 3, position = pos, max.overlaps = Inf) +
scale_color_manual(values =c("pink2", "salmon")) +
scale_shape_manual(values=c(19, 2, 11, 7, 3)) +
theme_classic() +
facet_wrap(~Gene, scales = "free_x", nrow = 2) +
scale_y_continuous(limits = c(-6, 5))
plot3
ggsave("Fig3d_3.eps", width = 6, height = 4, path ="/Users/mc32/Documents/Matt_Coelho/Bioinformatics/Res1/figures_export")
```
...
# MHH-ES-1
NT_MHHES1 <- annotated_data %>%
  filter(gene_alias == "non-targeting") %>%
  select(L2FC_MHHES1_Control_plasmid_average_zscore)

essential_MHHES1 <- annotated_data %>%
  filter(gene_alias == "essential") %>%
  select(L2FC_MHHES1_Control_plasmid_average_zscore)
...
annotate("text", y = 12.2, x = 1.7, label = paste("p =", formatC(t_test_1$p.value, digits = 2)), parse = FALSE, size = 4) +
theme_classic()
plot1
...
geom_point(size=3, alpha=1, position = pos, shape = 1) +
geom_violin(colour = "salmon", alpha = 1) +
annotate("text", y = 12.2, x = 1.6, label = paste("p =", formatC(t_test_2$p.value, digits = 2)), parse = FALSE, size = 4) +
theme_classic()
plot3
...
geom_point(size=3, alpha=1, position = pos, shape = 1) +
geom_violin(colour = "salmon", alpha = 1) +
annotate("text", y = 12.2, x = 1.6, label = paste("p =", formatC(t_test_3$p.value, digits = 2)), parse = FALSE, size = 4) +
theme_classic()
plot2
ggsave("FigS1b_2.eps", width = 6, height = 5, path ="/Users/mc32/Documents/Matt_Coelho/Bioinformatics/Res1/figures_export")

# MHH-ES-1
plot3 <- ggplot(annotated_data, aes(y = forcats::fct_relevel(gene_alias, "PARP1", "PARP2", "PIK3CA", "AKT1", "BCL2", "MAP2K1", "MAP2K2", "BRAF", "KRAS","EGFR","MYC", "essential", "non-essential", "non-targeting") , x = L2FC_MHHES1_Control_plasmid_average_zscore)) +
labs(title= "", y = "", x = "MHH-ES-1 control vs plasmid (z-score)") +
geom_point(size=3, alpha=1, position = pos, shape = 1) +
geom_violin(colour = "salmon", alpha = 1) +
annotate("text", y = 12.2, x = 1.6, label = paste("p =", formatC(t_test_4$p.value, digits = 2)), parse = FALSE, size = 4) +
theme_classic()
plot3
...
```{r}
#hits overalapping with validation screen
#gefit
...
geom_smooth(method = lm) +
annotate("text", y = 5, x = 0, label = paste("R = ", round(r1, 2)), parse = FALSE, size = 7) +
geom_text_repel(aes(label=ifelse(guide %in% c(gefit_hits$guide), paste0(Gene, ",", Amino_Acid_Position, ",", most_severe_consequence), "")), size = 3, position = pos) +
theme_bw(base_size = 15)
plot1
...
geom_smooth(method = lm) +
annotate("text", y = 5, x = 0, label = paste("R = ", round(r2, 2)), parse = FALSE, size = 7) +
geom_text_repel(aes(label=ifelse(guide %in% c(osim_hits$guide), paste0(Gene, ",", Amino_Acid_Position, ",", most_severe_consequence), "")), size = 3, position = pos) +
theme_bw(base_size = 15)
plot2
...
amplicon_valid <- select(amplicon_valid, c(Gene, G_guide, for_primer, rev_primer, chr, start, end, Location, editor, strand, Amino_Acid_Position, Protein_Change))
amplicon_valid %>% write.csv("Res1_amplicon_seq/ramplicon_valid.csv")
```

```{r}
# count how many variants we have try to install with base editing
annotated_data
